...
function wpnyc_testimonial_post_type()
{
...
add_action('init', 'wpnyc_testimonial_post_type', 0);
 ...
 */
function wpnyc_testimonial_notices( $messages ) {
    $post             = get_post();
...
add_filter( 'post_updated_messages', 'wpnyc_testimonial_notices' );
