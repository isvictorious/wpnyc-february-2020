<?php
/*
Plugin Name: wpnyc Functions
Plugin URI: https://github.com/isvictorious/wpnyc-2020
Description: Project specific functions plugin for this site
Version: 0.1.0
Author: Victor Ramirez
Author URI: https://www.isvictorious.com
Text Domain: wpnyc-functions
 ...
 *
 */
function wpnyc_disable_default_dashboard_widgets() {
...
add_action('wp_dashboard_setup', 'wpnyc_disable_default_dashboard_widgets', 999);
 ...
 * 
 */
function wpnyc_admin_bar_render() {
	global $wp_admin_bar;
...
add_action( 'wp_before_admin_bar_render', 'wpnyc_admin_bar_render' );
 ...
 *
 */
function wpnyc_remove_howdy( $wp_admin_bar ) {
...
add_filter( 'admin_bar_menu', 'wpnyc_remove_howdy',25 );
 ...
 *
 */
function wpnyc_hide_events_calendar_dashboard_widgets() {
...
add_action('wp_dashboard_setup', 'wpnyc_hide_events_calendar_dashboard_widgets', 20);
