 ...
 * @return void
 */
function wpnyc_editor_placeholder() {
    $placeholder = 'Start writing or add a block with / wpnyc';
    return $placeholder;
}
add_filter( 'write_your_story', 'wpnyc_editor_placeholder' );
 ...
 */
function wpnyc_instant_images_user_role(){   
	// https://codex.wordpress.org/Roles_and_Capabilities	   
	return 'activate_plugins';
}
add_filter('instant_images_user_role', 'wpnyc_instant_images_user_role');
 ...
 * @link http://url.com
 */
function wpnyc_genesis_editor_init()
{
...
add_action('admin_init', 'wpnyc_genesis_editor_init');
 ...
 * @return void
 */
function wpnyc_archive_post_class( $classes ) {
	global $wp_query;
...
add_filter( 'post_class', 'wpnyc_archive_post_class' );
 ...
 */
function wpnyc_archive_remove_post_meta() {
...
add_action ( 'genesis_entry_header', 'wpnyc_archive_remove_post_meta' );
 ...
 */
function wpnyc_read_more_link() {
	// return '... <a class="more-link" href="' . get_permalink() . '">[Continue Reading]</a>';
	return '';
}
add_filter( 'get_the_content_more_link', 'wpnyc_read_more_link' );
 ...
 * 
 */
function wpnyc_editor_allowed_block_types( $allowed_blocks ) {
...
if (!current_user_can('activate_plugins')) {
	add_filter( 'allowed_block_types', 'wpnyc_editor_allowed_block_types' );
	return;
}
